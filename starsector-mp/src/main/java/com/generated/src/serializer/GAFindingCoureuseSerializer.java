...
public class GAFindingCoureuseSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GAFindingCoureuse obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GAFindingCoureuse deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GAFindingCoureuse obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GAFindingCoureuse.class);
        return obj;
    }
