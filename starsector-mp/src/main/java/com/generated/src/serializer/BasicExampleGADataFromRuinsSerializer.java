...
public class BasicExampleGADataFromRuinsSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.BasicExampleGADataFromRuins obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.BasicExampleGADataFromRuins deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.BasicExampleGADataFromRuins obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.BasicExampleGADataFromRuins.class);
        return obj;
    }
