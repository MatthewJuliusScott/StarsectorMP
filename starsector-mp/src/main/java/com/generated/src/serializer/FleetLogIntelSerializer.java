...
public class FleetLogIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.misc.FleetLogIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.misc.FleetLogIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.misc.FleetLogIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.misc.FleetLogIntel.class);
        return obj;
    }
