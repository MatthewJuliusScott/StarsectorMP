...
public class BallisticProjectileSerializer {


    public byte[] serialize(com.fs.starfarer.combat.entities.BallisticProjectile obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.combat.entities.BallisticProjectile deserialize() {
        ...
        com.fs.starfarer.combat.entities.BallisticProjectile obj = objenesis.newInstance(com.fs.starfarer.combat.entities.BallisticProjectile.class);
        return obj;
    }
