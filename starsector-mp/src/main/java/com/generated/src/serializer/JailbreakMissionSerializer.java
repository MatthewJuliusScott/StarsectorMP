...
public class JailbreakMissionSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.JailbreakMission obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.JailbreakMission deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.JailbreakMission obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.JailbreakMission.class);
        return obj;
    }
