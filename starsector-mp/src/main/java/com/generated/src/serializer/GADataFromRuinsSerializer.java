...
public class GADataFromRuinsSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GADataFromRuins obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GADataFromRuins deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GADataFromRuins obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GADataFromRuins.class);
        return obj;
    }
