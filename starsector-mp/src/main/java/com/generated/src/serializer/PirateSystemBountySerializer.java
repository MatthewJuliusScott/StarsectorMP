...
public class PirateSystemBountySerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.PirateSystemBounty obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.PirateSystemBounty deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.PirateSystemBounty obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.PirateSystemBounty.class);
        return obj;
    }
