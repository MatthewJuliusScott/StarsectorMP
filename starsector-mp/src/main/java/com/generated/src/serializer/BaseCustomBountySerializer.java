...
public class BaseCustomBountySerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.cb.BaseCustomBounty obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.cb.BaseCustomBounty deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.cb.BaseCustomBounty obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.cb.BaseCustomBounty.class);
        return obj;
    }
