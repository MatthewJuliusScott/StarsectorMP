...
public class GAKallichoreSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GAKallichore obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GAKallichore deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GAKallichore obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GAKallichore.class);
        return obj;
    }
