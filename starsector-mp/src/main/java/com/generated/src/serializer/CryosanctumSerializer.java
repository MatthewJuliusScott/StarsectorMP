...
public class CryosanctumSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.econ.impl.Cryosanctum obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.econ.impl.Cryosanctum deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.econ.impl.Cryosanctum obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.econ.impl.Cryosanctum.class);
        return obj;
    }
