...
public class FarmingSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.econ.impl.Farming obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.econ.impl.Farming deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.econ.impl.Farming obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.econ.impl.Farming.class);
        return obj;
    }
