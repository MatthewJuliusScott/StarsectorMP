...
public class GADeliverVIPSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GADeliverVIP obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GADeliverVIP deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GADeliverVIP obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GADeliverVIP.class);
        return obj;
    }
