...
public class PirateActivityIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.bases.PirateActivityIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.bases.PirateActivityIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.bases.PirateActivityIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.bases.PirateActivityIntel.class);
        return obj;
    }
