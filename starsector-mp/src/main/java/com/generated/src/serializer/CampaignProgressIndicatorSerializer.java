...
public class CampaignProgressIndicatorSerializer {


    public byte[] serialize(com.fs.starfarer.campaign.CampaignProgressIndicator obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.campaign.CampaignProgressIndicator deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.campaign.CampaignProgressIndicator obj = objenesis.newInstance(com.fs.starfarer.campaign.CampaignProgressIndicator.class);
        return obj;
    }
