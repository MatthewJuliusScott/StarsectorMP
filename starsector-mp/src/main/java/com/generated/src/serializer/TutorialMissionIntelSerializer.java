...
public class TutorialMissionIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.tutorial.TutorialMissionIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.tutorial.TutorialMissionIntel deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.tutorial.TutorialMissionIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.tutorial.TutorialMissionIntel.class);
        return obj;
    }
