...
public class PromoteOfficerIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.PromoteOfficerIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.PromoteOfficerIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.PromoteOfficerIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.PromoteOfficerIntel.class);
        return obj;
    }
