...
public class WarningBeaconIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.misc.WarningBeaconIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.misc.WarningBeaconIntel deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.intel.misc.WarningBeaconIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.misc.WarningBeaconIntel.class);
        return obj;
    }
