...
public class UnderworldCustomBountySerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.cb.UnderworldCustomBounty obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.cb.UnderworldCustomBounty deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.cb.UnderworldCustomBounty obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.cb.UnderworldCustomBounty.class);
        return obj;
    }
