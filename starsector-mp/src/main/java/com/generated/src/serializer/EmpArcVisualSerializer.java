...
public class EmpArcVisualSerializer {


    public byte[] serialize(com.fs.starfarer.combat.systems.EmpArcVisual obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.combat.systems.EmpArcVisual deserialize() {
        ...
        com.fs.starfarer.combat.systems.EmpArcVisual obj = objenesis.newInstance(com.fs.starfarer.combat.systems.EmpArcVisual.class);
        return obj;
    }
