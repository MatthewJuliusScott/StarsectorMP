...
public class CommodityProductionMissionSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.CommodityProductionMission obj)
        throws IOException
    {
        ...
        return obj.getCompletionFlag().writeObject();
    ...
    public com.fs.starfarer.api.impl.campaign.missions.CommodityProductionMission deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.CommodityProductionMission obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.CommodityProductionMission.class);
        return obj;
    }
