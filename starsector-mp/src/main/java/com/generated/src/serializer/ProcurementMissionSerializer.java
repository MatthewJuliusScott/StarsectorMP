...
public class ProcurementMissionSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.ProcurementMission obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.ProcurementMission deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.missions.ProcurementMission obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.ProcurementMission.class);
        return obj;
    }
