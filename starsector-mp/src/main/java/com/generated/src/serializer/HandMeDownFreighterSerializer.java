...
public class HandMeDownFreighterSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.HandMeDownFreighter obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.HandMeDownFreighter deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.HandMeDownFreighter obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.HandMeDownFreighter.class);
        return obj;
    }
