...
public class AICoreGroundRaidObjectivePluginImplSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.graid.AICoreGroundRaidObjectivePluginImpl obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.graid.AICoreGroundRaidObjectivePluginImpl deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.graid.AICoreGroundRaidObjectivePluginImpl obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.graid.AICoreGroundRaidObjectivePluginImpl.class);
        return obj;
    }
