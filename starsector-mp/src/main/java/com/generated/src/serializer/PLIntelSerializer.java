...
public class PLIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.plog.PLIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.plog.PLIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.plog.PLIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.plog.PLIntel.class);
        return obj;
    }
