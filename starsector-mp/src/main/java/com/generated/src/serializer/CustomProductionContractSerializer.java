...
public class CustomProductionContractSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.CustomProductionContract obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.CustomProductionContract deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.CustomProductionContract obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.CustomProductionContract.class);
        return obj;
    }
