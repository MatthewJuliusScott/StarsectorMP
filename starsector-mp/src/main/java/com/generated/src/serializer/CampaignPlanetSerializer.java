...
public class CampaignPlanetSerializer {


    public byte[] serialize(com.fs.starfarer.campaign.CampaignPlanet obj)
        throws IOException
    {
        ...
        try {
            ...
            try {
                ISerializer serializer = MessageSerializer.getInstance().getSerializer((java.awt.Color.class));
                out.write(serializer.serialize(obj.getLightColorOverrideIfStar()));
            } catch (SerializerNotFoundException _x) {
            }
            try {
    ...
    public com.fs.starfarer.campaign.CampaignPlanet deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.campaign.CampaignPlanet obj = objenesis.newInstance(com.fs.starfarer.campaign.CampaignPlanet.class);
        return obj;
    }
