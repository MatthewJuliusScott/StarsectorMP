...
public class DeadDropMissionSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.DeadDropMission obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.DeadDropMission deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.DeadDropMission obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.DeadDropMission.class);
        return obj;
    }
