...
public class CustomCombatEntitySerializer {


    public byte[] serialize(com.fs.starfarer.combat.entities.CustomCombatEntity obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.combat.entities.CustomCombatEntity deserialize() {
        ...
        com.fs.starfarer.combat.entities.CustomCombatEntity obj = objenesis.newInstance(com.fs.starfarer.combat.entities.CustomCombatEntity.class);
        return obj;
    }
