...
public class GARansomResearcherSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GARansomResearcher obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GARansomResearcher deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GARansomResearcher obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GARansomResearcher.class);
        return obj;
    }
