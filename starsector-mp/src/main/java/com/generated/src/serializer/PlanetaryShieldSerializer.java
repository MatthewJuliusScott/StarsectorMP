...
public class PlanetaryShieldSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.econ.impl.PlanetaryShield obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.econ.impl.PlanetaryShield deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.econ.impl.PlanetaryShield obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.econ.impl.PlanetaryShield.class);
        return obj;
    }
