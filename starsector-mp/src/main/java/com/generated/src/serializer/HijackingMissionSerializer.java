...
public class HijackingMissionSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.HijackingMission obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.HijackingMission deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.HijackingMission obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.HijackingMission.class);
        return obj;
    }
