...
public class AnalyzeEntityMissionIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.AnalyzeEntityMissionIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.AnalyzeEntityMissionIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.AnalyzeEntityMissionIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.AnalyzeEntityMissionIntel.class);
        return obj;
    }
