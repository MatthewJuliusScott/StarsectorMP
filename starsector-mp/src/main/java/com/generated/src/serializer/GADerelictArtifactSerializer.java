...
public class GADerelictArtifactSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GADerelictArtifact obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GADerelictArtifact deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GADerelictArtifact obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GADerelictArtifact.class);
        return obj;
    }
