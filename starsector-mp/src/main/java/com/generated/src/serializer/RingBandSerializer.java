...
public class RingBandSerializer {


    public byte[] serialize(com.fs.starfarer.campaign.RingBand obj)
        throws IOException
    {
        ...
        try {
            ...
            out.writeFloat(obj.getMiddleRadius());
            out.writeFloat(obj.getMinSpiralRadius());
            ...
            out.writeFloat(obj.getOrbitDays());
            try {
                ISerializer serializer = MessageSerializer.getInstance().getSerializer((java.lang.Float.class));
            ...
            out.writeBoolean(obj.isSpiral());
            out.writeFloat(obj.getSpiralFactor());
    ...
    public com.fs.starfarer.campaign.RingBand deserialize() {
        ...
        com.fs.starfarer.campaign.RingBand obj = objenesis.newInstance(com.fs.starfarer.campaign.RingBand.class);
        return obj;
    }
