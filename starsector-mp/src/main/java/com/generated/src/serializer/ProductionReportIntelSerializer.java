...
public class ProductionReportIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.misc.ProductionReportIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.misc.ProductionReportIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.misc.ProductionReportIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.misc.ProductionReportIntel.class);
        return obj;
    }
