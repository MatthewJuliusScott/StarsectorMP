...
public class PlanetaryShieldIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.bar.events.PlanetaryShieldIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.bar.events.PlanetaryShieldIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.bar.events.PlanetaryShieldIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.bar.events.PlanetaryShieldIntel.class);
        return obj;
    }
