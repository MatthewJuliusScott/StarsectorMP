...
public class RaidIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.raid.RaidIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.raid.RaidIntel deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.intel.raid.RaidIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.raid.RaidIntel.class);
        return obj;
    }
