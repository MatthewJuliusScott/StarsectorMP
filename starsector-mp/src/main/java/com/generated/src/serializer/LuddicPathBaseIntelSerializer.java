...
public class LuddicPathBaseIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.bases.LuddicPathBaseIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.bases.LuddicPathBaseIntel deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.intel.bases.LuddicPathBaseIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.bases.LuddicPathBaseIntel.class);
        return obj;
    }
