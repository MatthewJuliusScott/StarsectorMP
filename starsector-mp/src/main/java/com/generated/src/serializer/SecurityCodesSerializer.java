...
public class SecurityCodesSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.SecurityCodes obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.SecurityCodes deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.SecurityCodes obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.SecurityCodes.class);
        return obj;
    }
