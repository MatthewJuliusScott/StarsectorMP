...
public class CargoPodsIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.misc.CargoPodsIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.misc.CargoPodsIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.misc.CargoPodsIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.misc.CargoPodsIntel.class);
        return obj;
    }
