...
public class BaseBarEventIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.bar.events.BaseBarEventIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.bar.events.BaseBarEventIntel deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.intel.bar.events.BaseBarEventIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.bar.events.BaseBarEventIntel.class);
        return obj;
    }
