...
public class LightIndustrySerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.econ.impl.LightIndustry obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.econ.impl.LightIndustry deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.econ.impl.LightIndustry obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.econ.impl.LightIndustry.class);
        return obj;
    }
