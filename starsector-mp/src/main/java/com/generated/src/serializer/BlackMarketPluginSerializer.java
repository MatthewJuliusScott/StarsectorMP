...
public class BlackMarketPluginSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.submarkets.BlackMarketPlugin obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.submarkets.BlackMarketPlugin deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.submarkets.BlackMarketPlugin obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.submarkets.BlackMarketPlugin.class);
        return obj;
    }
