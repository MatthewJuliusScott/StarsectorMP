...
public class GAReturnHamatsuSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GAReturnHamatsu obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GAReturnHamatsu deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GAReturnHamatsu obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GAReturnHamatsu.class);
        return obj;
    }
