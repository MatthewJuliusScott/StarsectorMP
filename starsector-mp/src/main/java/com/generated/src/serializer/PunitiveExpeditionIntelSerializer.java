...
public class PunitiveExpeditionIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.punitive.PunitiveExpeditionIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.punitive.PunitiveExpeditionIntel deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.intel.punitive.PunitiveExpeditionIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.punitive.PunitiveExpeditionIntel.class);
        return obj;
    }
