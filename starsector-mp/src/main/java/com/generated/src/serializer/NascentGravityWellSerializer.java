...
public class NascentGravityWellSerializer {


    public byte[] serialize(com.fs.starfarer.campaign.NascentGravityWell obj)
        throws IOException
    {
        ...
        try {
            ...
            try {
                ...
                out.write(serializer.serialize(obj.getColorOverride()));
            } catch (SerializerNotFoundException _x) {
            }
    ...
    public com.fs.starfarer.campaign.NascentGravityWell deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.campaign.NascentGravityWell obj = objenesis.newInstance(com.fs.starfarer.campaign.NascentGravityWell.class);
        return obj;
    }
