...
public class GateIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.misc.GateIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.misc.GateIntel deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.intel.misc.GateIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.misc.GateIntel.class);
        return obj;
    }
