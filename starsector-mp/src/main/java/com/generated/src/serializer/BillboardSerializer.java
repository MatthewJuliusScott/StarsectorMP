...
public class BillboardSerializer {
    ...
    public byte[] serialize(com.fs.starfarer.combat.entities.Billboard obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.combat.entities.Billboard deserialize() {
        ...
        com.fs.starfarer.combat.entities.Billboard obj = objenesis.newInstance(com.fs.starfarer.combat.entities.Billboard.class);
        return obj;
    }
