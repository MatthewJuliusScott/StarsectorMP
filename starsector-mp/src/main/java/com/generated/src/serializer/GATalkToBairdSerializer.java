...
public class GATalkToBairdSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GATalkToBaird obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GATalkToBaird deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GATalkToBaird obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GATalkToBaird.class);
        return obj;
    }
