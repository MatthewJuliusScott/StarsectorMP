...
public class SpecialItemRaidObjectivePluginImplSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.graid.SpecialItemRaidObjectivePluginImpl obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.graid.SpecialItemRaidObjectivePluginImpl deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.graid.SpecialItemRaidObjectivePluginImpl obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.graid.SpecialItemRaidObjectivePluginImpl.class);
        return obj;
    }
