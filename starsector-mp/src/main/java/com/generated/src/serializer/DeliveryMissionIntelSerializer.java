...
public class DeliveryMissionIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.bar.events.DeliveryMissionIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.bar.events.DeliveryMissionIntel deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.intel.bar.events.DeliveryMissionIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.bar.events.DeliveryMissionIntel.class);
        return obj;
    }
