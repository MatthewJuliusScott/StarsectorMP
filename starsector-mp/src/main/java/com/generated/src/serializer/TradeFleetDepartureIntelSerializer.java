...
public class TradeFleetDepartureIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.misc.TradeFleetDepartureIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.misc.TradeFleetDepartureIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.misc.TradeFleetDepartureIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.misc.TradeFleetDepartureIntel.class);
        return obj;
    }
