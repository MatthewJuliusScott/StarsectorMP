...
public class BaseIntelPluginSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.BaseIntelPlugin obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.BaseIntelPlugin deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.BaseIntelPlugin obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.BaseIntelPlugin.class);
        return obj;
    }
