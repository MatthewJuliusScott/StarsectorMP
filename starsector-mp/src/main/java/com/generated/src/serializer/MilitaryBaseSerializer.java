...
public class MilitaryBaseSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.econ.impl.MilitaryBase obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.econ.impl.MilitaryBase deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.econ.impl.MilitaryBase obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.econ.impl.MilitaryBase.class);
        return obj;
    }
