...
public class SurveyPlanetMissionIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.SurveyPlanetMissionIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.SurveyPlanetMissionIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.SurveyPlanetMissionIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.SurveyPlanetMissionIntel.class);
        return obj;
    }
