...
public class CreditsGroundRaidObjectivePluginImplSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.graid.CreditsGroundRaidObjectivePluginImpl obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.graid.CreditsGroundRaidObjectivePluginImpl deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.graid.CreditsGroundRaidObjectivePluginImpl obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.graid.CreditsGroundRaidObjectivePluginImpl.class);
        return obj;
    }
