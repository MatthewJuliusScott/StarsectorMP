...
public class NewMessagesIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.NewMessagesIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.NewMessagesIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.NewMessagesIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.NewMessagesIntel.class);
        return obj;
    }
