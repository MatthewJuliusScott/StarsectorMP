...
public class SpecialItemOfferSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.bar.events.historian.SpecialItemOffer obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.bar.events.historian.SpecialItemOffer deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.bar.events.historian.SpecialItemOffer obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.bar.events.historian.SpecialItemOffer.class);
        return obj;
    }
