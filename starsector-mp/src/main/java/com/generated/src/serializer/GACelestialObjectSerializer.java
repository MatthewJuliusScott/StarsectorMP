...
public class GACelestialObjectSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GACelestialObject obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GACelestialObject deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GACelestialObject obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GACelestialObject.class);
        return obj;
    }
