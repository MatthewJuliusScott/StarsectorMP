...
public class DisruptSpaceportSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.DisruptSpaceport obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.DisruptSpaceport deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.DisruptSpaceport obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.DisruptSpaceport.class);
        return obj;
    }
