...
public class CryorevivalSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.econ.impl.Cryorevival obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.econ.impl.Cryorevival deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.econ.impl.Cryorevival obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.econ.impl.Cryorevival.class);
        return obj;
    }
