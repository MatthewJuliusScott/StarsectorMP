...
public class RingSystemTerrainPluginSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.terrain.RingSystemTerrainPlugin obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.terrain.RingSystemTerrainPlugin deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.terrain.RingSystemTerrainPlugin obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.terrain.RingSystemTerrainPlugin.class);
        return obj;
    }
