...
public class GAProbePackageSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GAProbePackage obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GAProbePackage deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GAProbePackage obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GAProbePackage.class);
        return obj;
    }
