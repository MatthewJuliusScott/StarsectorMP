...
public class ScientistAICoreIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.bar.events.ScientistAICoreIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.bar.events.ScientistAICoreIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.bar.events.ScientistAICoreIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.bar.events.ScientistAICoreIntel.class);
        return obj;
    }
