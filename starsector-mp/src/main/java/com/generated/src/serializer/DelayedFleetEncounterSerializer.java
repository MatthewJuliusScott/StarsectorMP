...
public class DelayedFleetEncounterSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.DelayedFleetEncounter obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.DelayedFleetEncounter deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.DelayedFleetEncounter obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.DelayedFleetEncounter.class);
        return obj;
    }
