...
public class SmugglingMissionSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.SmugglingMission obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.SmugglingMission deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.SmugglingMission obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.SmugglingMission.class);
        return obj;
    }
