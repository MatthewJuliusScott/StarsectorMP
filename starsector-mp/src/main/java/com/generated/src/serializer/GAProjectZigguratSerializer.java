...
public class GAProjectZigguratSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GAProjectZiggurat obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GAProjectZiggurat deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GAProjectZiggurat obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GAProjectZiggurat.class);
        return obj;
    }
