...
public class GAOutpostSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GAOutpost obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GAOutpost deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GAOutpost obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GAOutpost.class);
        return obj;
    }
