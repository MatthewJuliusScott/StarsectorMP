...
public class DisruptHeavyIndustrySerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.DisruptHeavyIndustry obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.DisruptHeavyIndustry deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.DisruptHeavyIndustry obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.DisruptHeavyIndustry.class);
        return obj;
    }
