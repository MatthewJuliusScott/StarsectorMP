...
public class GAIntroSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GAIntro obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GAIntro deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GAIntro obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GAIntro.class);
        return obj;
    }
