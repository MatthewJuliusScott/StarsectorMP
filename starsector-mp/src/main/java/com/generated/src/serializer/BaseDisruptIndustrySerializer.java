...
public class BaseDisruptIndustrySerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.BaseDisruptIndustry obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.BaseDisruptIndustry deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.BaseDisruptIndustry obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.BaseDisruptIndustry.class);
        return obj;
    }
