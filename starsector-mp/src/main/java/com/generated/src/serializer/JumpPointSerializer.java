...
public class JumpPointSerializer {


    public byte[] serialize(com.fs.starfarer.campaign.JumpPoint obj)
        throws IOException
    {
        ...
        try {
            ...
            out.writeBoolean(obj.isAutoCreateEntranceFromHyperspace());
            ...
            JumpDestination[] destinationsArray = obj.getDestinations().toArray(new JumpDestination[ 0 ] );
            out.writeInt(destinationsArray.length);
    ...
    public com.fs.starfarer.campaign.JumpPoint deserialize() {
        ...
        com.fs.starfarer.campaign.JumpPoint obj = objenesis.newInstance(com.fs.starfarer.campaign.JumpPoint.class);
        return obj;
    }
