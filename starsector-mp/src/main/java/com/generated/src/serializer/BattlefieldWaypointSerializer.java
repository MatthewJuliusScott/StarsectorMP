...
public class BattlefieldWaypointSerializer {


    public byte[] serialize(com.fs.starfarer.combat.entities.BattlefieldWaypoint obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.combat.entities.BattlefieldWaypoint deserialize() {
        ...
        com.fs.starfarer.combat.entities.BattlefieldWaypoint obj = objenesis.newInstance(com.fs.starfarer.combat.entities.BattlefieldWaypoint.class);
        return obj;
    }
