...
public class GroundDefensesSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.econ.impl.GroundDefenses obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.econ.impl.GroundDefenses deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.econ.impl.GroundDefenses obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.econ.impl.GroundDefenses.class);
        return obj;
    }
