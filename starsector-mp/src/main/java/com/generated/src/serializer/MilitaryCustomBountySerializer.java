...
public class MilitaryCustomBountySerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.cb.MilitaryCustomBounty obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.cb.MilitaryCustomBounty deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.missions.cb.MilitaryCustomBounty obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.cb.MilitaryCustomBounty.class);
        return obj;
    }
