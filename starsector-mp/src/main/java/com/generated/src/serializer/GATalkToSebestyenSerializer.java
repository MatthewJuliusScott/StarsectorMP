...
public class GATalkToSebestyenSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GATalkToSebestyen obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GATalkToSebestyen deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GATalkToSebestyen obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GATalkToSebestyen.class);
        return obj;
    }
