...
public class TacticallyBombardColonySerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.TacticallyBombardColony obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.TacticallyBombardColony deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.TacticallyBombardColony obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.TacticallyBombardColony.class);
        return obj;
    }
