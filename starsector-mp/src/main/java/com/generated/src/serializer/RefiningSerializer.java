...
public class RefiningSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.econ.impl.Refining obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.econ.impl.Refining deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.econ.impl.Refining obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.econ.impl.Refining.class);
        return obj;
    }
