...
public class GAAtTheGatesSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GAAtTheGates obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GAAtTheGates deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GAAtTheGates obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GAAtTheGates.class);
        return obj;
    }
