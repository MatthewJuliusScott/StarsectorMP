...
public class FactionHostilityIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.FactionHostilityIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.FactionHostilityIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.FactionHostilityIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.FactionHostilityIntel.class);
        return obj;
    }
