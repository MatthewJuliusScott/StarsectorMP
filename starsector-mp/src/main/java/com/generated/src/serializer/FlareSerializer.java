...
public class FlareSerializer {


    public byte[] serialize(com.fs.starfarer.combat.systems.Flare obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.combat.systems.Flare deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.combat.systems.Flare obj = objenesis.newInstance(com.fs.starfarer.combat.systems.Flare.class);
        return obj;
    }
