...
public class ExtractionMissionSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.ExtractionMission obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.ExtractionMission deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.ExtractionMission obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.ExtractionMission.class);
        return obj;
    }
