...
public class ShipBlueprintOfferSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.bar.events.historian.ShipBlueprintOffer obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.bar.events.historian.ShipBlueprintOffer deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.intel.bar.events.historian.ShipBlueprintOffer obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.bar.events.historian.ShipBlueprintOffer.class);
        return obj;
    }
