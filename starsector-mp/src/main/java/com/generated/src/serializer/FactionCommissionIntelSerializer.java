...
public class FactionCommissionIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.FactionCommissionIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.FactionCommissionIntel deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.intel.FactionCommissionIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.FactionCommissionIntel.class);
        return obj;
    }
