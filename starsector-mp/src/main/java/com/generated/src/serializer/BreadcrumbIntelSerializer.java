...
public class BreadcrumbIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.misc.BreadcrumbIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.misc.BreadcrumbIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.misc.BreadcrumbIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.misc.BreadcrumbIntel.class);
        return obj;
    }
