...
public class DisruptIndustryRaidObjectivePluginImplSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.graid.DisruptIndustryRaidObjectivePluginImpl obj)
        throws IOException
    {
        ...
        try {
            ...
            out.writeFloat(obj.getAddedDisruptionDays());
            try {
    ...
    public com.fs.starfarer.api.impl.campaign.graid.DisruptIndustryRaidObjectivePluginImpl deserialize() {
        ...
        com.fs.starfarer.api.impl.campaign.graid.DisruptIndustryRaidObjectivePluginImpl obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.graid.DisruptIndustryRaidObjectivePluginImpl.class);
        return obj;
    }
