...
public class GABuyArtifactSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GABuyArtifact obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GABuyArtifact deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GABuyArtifact obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GABuyArtifact.class);
        return obj;
    }
