...
public class CheapCommodityMissionSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.CheapCommodityMission obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.CheapCommodityMission deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.CheapCommodityMission obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.CheapCommodityMission.class);
        return obj;
    }
