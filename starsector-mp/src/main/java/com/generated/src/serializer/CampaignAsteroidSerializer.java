...
public class CampaignAsteroidSerializer {


    public byte[] serialize(com.fs.starfarer.campaign.CampaignAsteroid obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.campaign.CampaignAsteroid deserialize() {
        ...
        com.fs.starfarer.campaign.CampaignAsteroid obj = objenesis.newInstance(com.fs.starfarer.campaign.CampaignAsteroid.class);
        return obj;
    }
