...
public class GATransverseJumpSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.academy.GATransverseJump obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.academy.GATransverseJump deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.academy.GATransverseJump obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.academy.GATransverseJump.class);
        return obj;
    }
