...
public class SurplusShipHullSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.missions.SurplusShipHull obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.missions.SurplusShipHull deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.missions.SurplusShipHull obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.missions.SurplusShipHull.class);
        return obj;
    }
