...
public class DecivIntelSerializer {


    public byte[] serialize(com.fs.starfarer.api.impl.campaign.intel.deciv.DecivIntel obj)
        throws IOException
    {
    ...
    public com.fs.starfarer.api.impl.campaign.intel.deciv.DecivIntel deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.api.impl.campaign.intel.deciv.DecivIntel obj = objenesis.newInstance(com.fs.starfarer.api.impl.campaign.intel.deciv.DecivIntel.class);
        return obj;
    }
