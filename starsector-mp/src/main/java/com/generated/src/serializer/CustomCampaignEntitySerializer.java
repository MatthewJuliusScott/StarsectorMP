...
public class CustomCampaignEntitySerializer {


    public byte[] serialize(com.fs.starfarer.campaign.CustomCampaignEntity obj)
        throws IOException
    {
        ...
        try {
            ...
            try {
                ...
                out.write(serializer.serialize(obj.getFleetForVisual()));
            } catch (SerializerNotFoundException _x) {
            }
    ...
    public com.fs.starfarer.campaign.CustomCampaignEntity deserialize() {
        Objenesis objenesis = new ObjenesisStd();
        com.fs.starfarer.campaign.CustomCampaignEntity obj = objenesis.newInstance(com.fs.starfarer.campaign.CustomCampaignEntity.class);
        return obj;
    }
